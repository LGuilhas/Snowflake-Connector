...
namespace SnowflakeDatabaseProvider.DML {
    ...
    /// </summary>
    public class SnowflakeDMLEntityActions : BaseDMLEntityActions {
        ...
        internal SnowflakeDMLEntityActions(IDMLService dmlService, ITableSourceInfo tableSourceInfo) : base(dmlService, tableSourceInfo) { }
        ...
        {
			#warning "Does it make sense on this kind of DB?"
