...
using SnowflakeDatabaseProvider.DML;
using SnowflakeDatabaseProvider.Execution;
using SnowflakeDatabaseProvider.Introspection;
using SnowflakeDatabaseProvider.Transaction;
...
namespace SnowflakeDatabaseProvider {
    ...
    /// </summary>
    public class SnowflakeDatabaseServices : IDatabaseServices {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SnowflakeDatabaseServices"/> class.
        /// </summary>
        /// <param name="databaseConfiguration">The database configuration.</param>
        public SnowflakeDatabaseServices(IRuntimeDatabaseConfiguration databaseConfiguration) {
            _configuration = databaseConfiguration;
            _objectFactory = new SnowflakeDatabaseObjectFactory(this);
            _transactionService = new SnowflakeTransactionService(this);
            _executionService = new SnowflakeExecutionService(this);
            _dmlService = new SnowflakeDMLService(this);
            _introspectionService = new SnowflakeIntrospectionService(this);
        }
