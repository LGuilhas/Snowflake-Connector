...
namespace SnowflakeDatabaseProvider {
    ...
    /// </summary>
    public class SnowflakeDatabaseProvider : BaseDatabaseProvider {

        private readonly IProviderProperties properties;

        public static readonly IDatabaseProvider Instance = new SnowflakeDatabaseProvider();

        public SnowflakeDatabaseProvider()
        {
            properties = new SnowflakeProviderProperties(this);
        }
        ...
        public override IDatabaseServices GetIntegrationDatabaseServices(IRuntimeDatabaseConfiguration databaseConfiguration) {
            return new SnowflakeDatabaseServices(databaseConfiguration);
        }
        ...
        public override DatabaseProviderKey Key {
            get { return DatabaseProviderKey.Deserialize("Snowflake"); }
        }
        ...
        public override IIntegrationDatabaseConfiguration CreateEmptyIntegrationDatabaseConfiguration() {
            return new SnowflakeDatabaseConfiguration();
        }
