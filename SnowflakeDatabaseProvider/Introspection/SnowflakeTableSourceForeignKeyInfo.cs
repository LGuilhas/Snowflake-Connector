...
namespace SnowflakeDatabaseProvider.Introspection {
    ...
    /// </summary>
    public class SnowflakeTableSourceForeignKeyInfo : ITableSourceForeignKeyInfo {
        ...
        public SnowflakeTableSourceForeignKeyInfo(ITableSourceInfo tableSource, string name, string columnName, ITableSourceInfo referencedTableSource, string referencedColumnName, bool isCascadeDelete)
        {
